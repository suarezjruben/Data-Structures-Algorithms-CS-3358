...
{
   if (headX == 0 && headY == 0) //If both X-list and Y-list are empty
   {
      return;
   }

   else if(headX != 0 && headY == 0) //X-list NOT empty, Y-list empty
   {
      headZ = headX;
      headX = 0;
   }

   else if(headX == 0 && headY != 0) //Y-list NOT empty, X-list empty
   {
      headZ = headY;
      headY = 0;
   }

   else if(headX != 0 && headY != 0) //X-list NOT empty, Y-list NOT empty
   {
      if(headX -> data < headY -> data) //X-list element less than Y-list element
      {
           headZ = headX;
           headX = headX -> link;
           headZ -> link = 0;
      ...
      else  //Y-list element less than X-list element
      {
           headZ = headY;
           headY = headY -> link;
           headZ -> link = 0;
